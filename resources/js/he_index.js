...
$(document).ready(function() {
	...
	myAudio = new Audio('resources/music/aprilshowers.mp3'); 	
    ...
    function typeboot() {
        $('#terminal').typist('print', '[   16.388364] cfg80211: World regulatory domain updated:<br/> \
